...
/**
 * Created by madhu on 17-04-2017.
 * Mail class.
 * Authenticates the sender's address and sends email.
 */
...
public class Mail extends javax.mail.Authenticator {
    ...
    public boolean send() throws Exception {
        ...
        if(!_user.equals("") && !_from.equals("") && !_subject.equals("") && !_body.equals("")) {
    ...
    public PasswordAuthentication getPasswordAuthentication() {
        return new PasswordAuthentication(_user, "***");
    }

    /**
     * Setting properties of the Mail instance.
     * @return
     */
