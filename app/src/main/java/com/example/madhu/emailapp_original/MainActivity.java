 ...
 * Main Activity
 * Google Login & Authentication, Firebase Login & Authentication
 * If signed in, show Continue Button
 */
...
public class MainActivity extends BaseActivity implements GoogleApiClient.OnConnectionFailedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Click the Button to go to Next Screen
    ...
    private void updateUI(FirebaseUser user) {
        ...
        //    Toast.makeText(this, "Logged In", Toast.LENGTH_SHORT).show();
            icon.setImageResource(R.drawable.welcome);
            mStatusTextView.setText(getString(R.string.google_status_fmt, user.getEmail()));

            findViewById(R.id.sign_in_button).setVisibility(View.GONE);
            findViewById(R.id.sign_out_and_disconnect).setVisibility(View.VISIBLE);
        } else {
        //    Toast.makeText(this, "Not able to Log In", Toast.LENGTH_SHORT).show();
            icon.setImageResource(R.drawable.sign_in);
